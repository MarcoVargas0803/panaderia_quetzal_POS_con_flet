        ...
        header = ft.Container(
            content=ft.Row([
                ...
                ft.Row([
                    ...
                    ft.TextButton("Producción", icon=ft.Icons.BAKERY_DINING, style=ft.ButtonStyle(color=ft.Colors.GREY)),
                    ft.TextButton("Consultas", icon=ft.Icons.SEARCH, style=ft.ButtonStyle(color=ft.Colors.GREY)),
                ], spacing=20),
                self.btn_blanco("Cerrar Sesión")
