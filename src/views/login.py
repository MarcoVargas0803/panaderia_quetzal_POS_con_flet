            ...
            controls=[
                ...
                ft.Container(
                    content=ft.Column([
                        ...
                        ft.Button("Iniciar Sesión", on_click=lambda _: self.navegar("/ventana_principal"), width=200, height=45, style=ft.ButtonStyle(bgcolor=self.COLOR_MARINO, color="white", ))
